...
import StepsChart30Days from '../screens/habits/dailySteps/AvgSteps.js';
...
export default function HabitsStack() {
  return (
    ...
    >
      ...
      />
      <Stack.Screen name="SleepChartDays" component={SleepChart} />
      <Stack.Screen
      ...
      />
      <Stack.Screen name="StepsChart30Days" component={StepsChart30Days} />
    </Stack.Navigator>
  );
}
