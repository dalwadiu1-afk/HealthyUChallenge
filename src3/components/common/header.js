...
export function Header({
  ...
  return (
    <View
      style={{ flexDirection: 'row', ...headerContainer, marginBottom: 10 }}
    >
      <Animated.View style={[styles.btnWrap, headerAnimStyle]}>
        <TouchableOpacity
      ...
      {showRightBtn ? (
        ...
        <View style={{ width: height * 0.06, height: height * 0.06 }} />
      )}
    </View>
  );
}
